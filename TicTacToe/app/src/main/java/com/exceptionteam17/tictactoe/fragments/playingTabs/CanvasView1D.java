...
public class CanvasView1D extends View { //you have to create a new java file and then insert the same
    ...
    private Paint painto = new Paint();
    private Paint painto1 = new Paint();
    private boolean oncewin = false;
    private boolean oncedrawen = false;
    private int sum = 0;
    private int[][] a = new int[3][3];
    private float[][] midx = new float[3][3];
    private float[][] midy = new float[3][3];
    private int turn = 0;
    private Context ctx;
    private float canvasSide, cellSide;
